# -*- coding: utf-8 -*-
# Generated by Django 1.9.7 on 2016-07-15 06:07
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pop2005', models.IntegerField(verbose_name='Populcation 2005')),
                ('fips', models.CharField(max_length=2, verbose_name='FIPS Code')),
                ('iso2', models.CharField(max_length=2, verbose_name='2 Digit ISO')),
                ('iso3', models.CharField(max_length=3, verbose_name='2 Digit ISO')),
